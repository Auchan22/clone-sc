...
const SERVICES: Servicios[] = [
...

  {
    ...
    description:
      '¿Tus clientes necesitan una locución comercial? No sólo se trata de una bonita voz, sino de hacer llegar un mensaje de forma precisa para que su marca se pueda vender de la manera adecuada. \n Encuentra la voz perfecta para el audio o video de tus clientes en cualquier estilo con nuestro servicio de locutores profesionales.',
    price: 300,
    img: 'https://lirp.cdn-website.com/7b521824/dms3rep/multi/opt/nuestros2e2ee-servicios-2020-febrero-1920w.png',
    href: '',
  },
  {
  ...
  },
  {
    ...
    description:
      'Con esta revolucionaria herramienta ahora puedes vender y cobrar tus productos o servicios a través de un catálogo digital dentro de WhatsApp Business. También mantienes contacto con tus clientes en el clásico chat que WhatsApp ofrece. \n Ya no batalles más escribiendo a tus clientes el precio de todos tus productos o buscando la mejor fotopara enviárselas. Nosotros te creamos tu catálogo digital para que tus clientes consulten tus productos en cualquier momento.  ',
    price: 0,
    img: 'https://lirp.cdn-website.com/5a4f43f8/dms3rep/multi/opt/Catalogo-Whats-1920w.png',
    href: '',
  },
  {
    title: 'Menú Digital',
